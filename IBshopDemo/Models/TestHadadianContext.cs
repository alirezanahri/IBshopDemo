...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        // => optionsBuilder.UseSqlServer("Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=TestHadadian;Data Source=.");
        => optionsBuilder.UseSqlServer("Server=1011944T1086955\\MSSQLSERVER3;Database=TestHadadian;user id=sa;pwd=sql;Trusted_Connection=True;encrypt=false");

    //    protected override void OnModelCreating(ModelBuilder modelBuilder)
    //    {
    //        modelBuilder.Entity<ArtMonthlyReport>(entity =>
    //        {
    //            entity.ToTable("ArtMonthlyReport");
    ...
    //            entity.ToTable("BranchManagerMonthlyReport");
    ...
    //            entity.ToTable("BranchesMonthlyReport");
    ...
    //        {
    //            entity.HasKey(e => e.Crmmrid).HasAnnotation("SqlServer:Identity", "1, 1");

    //            entity.ToTable("CRMMonthlyReports");
    ...
    //        {
    //            entity.HasKey(e => e.FinancialMonthlyReportId);

    //            entity.ToTable("FinancialMonthlyReport");

    //            entity.Property(e => e.FinancialMonthlyReportId)
    //                .ValueGeneratedNever()
    //                .HasColumnName("FinancialMonthlyReportId");
    //            entity.Property(e => e.Month)
    //                .HasMaxLength(10)
    //                .IsFixedLength();
    ...
    //            entity.ToTable("MarketingMonthlyReport");
    ...
    //        {
    //            entity.ToTable("OperationMonthlyReport");
    ...
    //            entity.ToTable("ProductDevelopmentMontylyReport");
    ...
    //        {
    //            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A35115B3DD3");

    //            entity.ToTable("UserRole");

    //            entity.HasOne(d => d.Role).WithMany(p => p.UserRoles)
    //                .HasForeignKey(d => d.RoleId)
    //                .HasConstraintName("FK__UserRole__RoleId__778AC167");
